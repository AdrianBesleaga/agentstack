...
auth:
  ...
  keycloakIssuerUrl: "http://keycloak:8336/realms/agentstack" # Internal URL
  
  # Next.js settings
  nextauthUrl: "http://localhost:8334" # Public URL of the UI
  apiUrl: "http://localhost:8333"      # Public URL of the API
```
